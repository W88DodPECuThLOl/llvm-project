...
#define DEBUG_TYPE "z80-reg-info"

using namespace llvm;

Z80RegisterInfo::Z80RegisterInfo(const Z80Subtarget &ST)
...
Z80RegisterInfo::getPointerRegClass(const MachineFunction &MF,
  ...
  case 0: return &Z80::R16RegClass;
  case 1: return &Z80::G16RegClass;
  case 2: return &Z80::O16RegClass;
  case 3: return &Z80::A16RegClass;
  case 4: return &Z80::I16RegClass;
  }
}
...
BitVector Z80RegisterInfo::getReservedRegs(const MachineFunction &MF) const {
  ...
  for (Register Reg :
       {Register(Z80::IX), getFrameRegister(MF)})
